...
public class MapCompressTest {
    ...
    public void testCompress() {
        ...
        Compress userCompress = new MapCompress(userMap, TypeBuilder.map(Integer.class, User.class), objectMapper);
    ...
    public void testCheck() {
        ObjectMapper objectMapper = new ObjectMapper();
        Compress userCompress = new MapCompress(userMap, TypeBuilder.map(Integer.class, User.class), objectMapper);
        Compress catCompress = new MapCompress(catMap, TypeBuilder.map(Integer.class, Cat.class), objectMapper);
