...
public class MultiTest {
    ...
    public void thenApplyTest() {
        ...
        String join = MultiHelper.create(executor)
            .thenApply(o -> "测试")
            .thenApply(s -> s + "测试")
            .join();
    ...
    public void thenCombineTest() {
        ...
        Integer join = MultiHelper.create(executor)
            .thenApply(o -> 2)
            .thenCombine(multi1, Integer::sum)
            .join();
