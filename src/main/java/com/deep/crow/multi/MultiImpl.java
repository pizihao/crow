...
public class MultiImpl<T> implements Multi<T> {
  ...
  private MultiImpl(ExecutorService executorService, CompletableFuture<T> completableFuture) {
  ...
  protected MultiImpl(ExecutorService executorService, Runnable runnable) {
    this(
        executorService,
        (CompletableFuture<T>) CompletableFuture.runAsync(runnable, executorService));
  }
  ...
  public Multi<T> copyMulti() {
    CompletableFuture<T> async =
        CompletableFuture.supplyAsync(() -> completableFuture.join(), executorService);
  ...
  public <U> Multi<U> thenApply(Function<? super T, ? extends U> fn) {
    completableFuture =
        (CompletableFuture<T>) completableFuture.thenApplyAsync(fn, executorService);
  ...
  public Multi<Void> thenAccept(Consumer<? super T> action) {
    completableFuture =
        (CompletableFuture<T>) completableFuture.thenAcceptAsync(action, executorService);
  ...
  public Multi<Void> thenRun(Runnable action) {
    completableFuture =
        (CompletableFuture<T>) completableFuture.thenRunAsync(action, executorService);
    return (Multi<Void>) new MultiImpl<>(executorService, completableFuture);
  }

  @Override
  public <U, V> Multi<V> thenCombine(
  ...
  @Override
  public <U> Multi<Void> thenBiAccept(
      Multi<? extends U> other, BiConsumer<? super T, ? super U> action) {
    completableFuture =
        (CompletableFuture<T>)
  ...
  public <U, M extends T> Multi<U> applyFun(Multi<M> other, Function<M, U> fn) {
    ...
    completableFuture =
        (CompletableFuture<T>)
            completableFuture.thenApplyAsync(r -> fn.apply(other.join()), executorService);
    return (Multi<U>) new MultiImpl<>(executorService, completableFuture);
  }
  ...
  public <M extends T> Multi<Void> acceptFun(Multi<M> other, Consumer<M> action) {
    ...
    completableFuture =
        (CompletableFuture<T>)
            completableFuture.thenAcceptAsync(r -> action.accept(other.join()), executorService);
    return (Multi<Void>) new MultiImpl<>(executorService, completableFuture);
  }
