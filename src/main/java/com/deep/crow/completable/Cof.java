...
/**
 * 基于{@link CompletableFuture}的扩展器
 *
 * <p>其实现类应提供对应的容器存放需要执行的任务，任务的形式支持{@link CompletableFuture}所提供的几种形式：
 *
 * <ul>
 *   <li>{@link Supplier}
 *   <li>{@link Runnable}
 * </ul>
 *
 * <p>本类的实现者可根据需求使用{@link CompletableFuture#get()}或者{@link CompletableFuture#join()}方法获取结果
 *
 * <p>注意执行器的适用范围，针对整个容器，针对一个任务或是不使用执行器
 *
 * <p>说明：
 *
 * <ul>
 *   <li>S: 任务所属类型，如：{@link Supplier}或{@link Runnable}
 *   <li>R: 容器最终返回值类型，如：{@link Map}或{@link Tuple}
 * </ul>
 *
